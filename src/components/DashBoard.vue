      ...
      <div class="container">
        ...
        <div class="col-9">
          <div class="statuses">
            <h3>Status</h3>
            <br />
            <input v-model="newStatus"  placeholder="Enter new status!!" /> <br />
            <br />
            <button class="dark-btn" style="margin-left: 90%;" v-on:click="changeStatus">POST</button>
          </div>
...
<script>
    ...
    export default {
        ...
        methods:{
          async changeStatus(){
            await axios.patch('http://localhost:5000/api/user/status',
